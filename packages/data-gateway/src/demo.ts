        ...
        nodes: [
          {
            ...
            label: "Факт",
            kind: "fact",
            summary: "Подтверждённое наблюдение в текущем исследовании.",
            confidence: 0.92,
            evidenceRefs: ["source-1"],
            provenanceRefs: ["alina-demo-adapter"],
          },
          {
            id: "source-1",
            label: "Источник",
            kind: "source",
            summary: "Исходный документ / материал.",
            confidence: 1,
            provenanceRefs: ["alina-demo-adapter"],
          },
          {
            ...
            label: "Сущность",
            kind: "entity",
            summary: "Связанная сущность исследования.",
            confidence: 0.84,
            provenanceRefs: ["alina-demo-adapter"],
          },
          {
            ...
            label: "Гипотеза",
            kind: "hypothesis",
            summary: "Рабочая гипотеза, требующая проверки.",
            confidence: 0.61,
            evidenceRefs: ["source-1"],
            provenanceRefs: ["alina-demo-adapter"],
          },
          {
            ...
            label: "Контроль",
            kind: "control",
            summary: "Контрольная точка / правило проверки.",
            confidence: 0.8,
            provenanceRefs: ["alina-demo-adapter"],
          },
        ],
        edges: [
          { id: "edge-1", source: "source-1", target: "fact-1", kind: "supports", confidence: 0.97 },
          { id: "edge-2", source: "fact-1", target: "entity-1", kind: "relates-to", confidence: 0.88 },
          { id: "edge-3", source: "hypothesis-1", target: "fact-1", kind: "contradicts", summary: "DEMO contradiction requiring review", confidence: 0.64 },
          { id: "edge-4", source: "control-1", target: "entity-1", kind: "controls", confidence: 0.81 },
          { id: "edge-5", source: "hypothesis-1", target: "source-1", kind: "derived-from", confidence: 0.7 },
        ],
      },
    },
    secondary: [
